$(document).ready(function() {
	...
	var _toDelete = function (_form) {

		var _serialize_data = $(_form).serialize();
		if(_serialize_data.indexOf('marked') == -1) {
			dialog({
				title: "提示",
				width: 460,
				content: "请先选择要删除的记录！",
...
/*	$("#delete").click(function() {
	...
	var _toEdit = function (_form) {
		...
		}else if(_serialize_data.indexOf('&') > -1) {
			dialog({
				title: "提示",
				width: 460,
				content: "只能选择唯一一条编辑记录！",
				okValue: "确认",
				ok: function () {}
			}).show();
		} else {
